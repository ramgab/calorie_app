...
public class SnackDetailsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        NestedScrollView nestedScrollView = rootView.findViewById(R.id.nestedscrollview_snack_details);
        ...
        adapter = new SnackDetailsAdapter(requireContext(), this, selectedDate);
